...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItem(Long userId, CreateUpdateItemDto itemDto) {
        return post("", userId, itemDto);
    }

    public ResponseEntity<Object> updateItem(Long userId, CreateUpdateItemDto itemDtoUpdate, Long itemId) {
